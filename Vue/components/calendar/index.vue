<template>
	<div class="_calendar-wrap">
		<div class="wh_top_changge">
			<div class="wh_jiantou wh_jiantou1" @click="PreMonth(myDate,false)"></div>
			<div class="wh_date">{{dateTop}}</div>
			<div class="wh_jiantou wh_jiantou2" @click="NextMonth(myDate,false)"></div>
		</div>
		...
		<div class="wh_main wh_content">
			<div v-for="(item,index) in list" @click="clickDay(item,index)" class="wh_content_item">
...
export default {
	...
	methods: {
		...
		getList: function(date, chooseDay, isChosedDay = true) {
			...
			this.dateTop = `${date.getFullYear()}.${date.getMonth()*1 > 8 ? date.getMonth()+1 : '0' + (date.getMonth()+ 1) }`;
